...
myKeys =
    ...
    -- KB_GROUP Run Prompt CHANGE NEXT
    ...
    -- KB_GROUP Workspaces DO NOT NEED
    ...
    -- KB_GROUP Grid Select (CTR-g followed by a key)
        , ("C-g b", bringSelected $ mygridConfig myColorizer) -- bring selected window VERY USEFUL

...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    cond = { true },
    config = { "\27LJ\2\nY\0\0\3\0\5\0\b6\0\0\0009\0\1\0'\2\2\0B\0\2\0016\0\3\0'\2\4\0B\0\2\1K\0\1\0\25extensions.cmp-setup\frequire\17:iunmap <CR>\bcmd\bvim\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = true,

...
;; [[file:config.org::*Make manual pages look nice][Make manual pages look nice:1]]
...
;; [[file:config.org::*Undo tree][Undo tree:2]]
(package! undo-tree)
;; Undo tree:2 ends here

;; [[file:config.org::*Jupyter][Jupyter:2]]
(package! jupyter)
;; Jupyter:2 ends here
